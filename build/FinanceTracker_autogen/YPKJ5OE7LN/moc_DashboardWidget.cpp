...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_DashboardWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_DashboardWidget_t qt_meta_stringdata_DashboardWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_DashboardWidget[] = {
...
Q_CONSTINIT const QMetaObject DashboardWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_DashboardWidget.offsetsAndSizes,
    qt_meta_data_DashboardWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_DashboardWidget_t,
        // Q_OBJECT / Q_GADGET
